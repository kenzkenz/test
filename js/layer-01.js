...
var pale1 = new ol.layer.Tile({
    ...
    origin:"国土地理院",
    detail:"国土地理院の淡色地図",
    icon:"<i class='fa fa-map-o' style='color:dimgrey;'></i>",
...
var ort1 = new ol.layer.Tile({
    ...
    origin:"",
    detail:"",
    icon:"<i class='fa fa-picture-o' style='color:green;'></i>",
...
var tunami1 = new ol.layer.Tile({
    ...
    origin:"",
    detail:"",
    icon:"<i class='fa fa-exclamation-triangle' style='color:dimgrey;'></i>",
	source: new ol.source.XYZ({
		attributions:[new ol.Attribution({html:"<a href='http://maps.gsi.go.jp/development/ichiran.html' target='_blank'>国土地理院</a>"})],
...
var ryuuiki1 = new ol.layer.Tile({
    ...
    icon:"<i class='fa fa-map-o' style='color:blue;'></i>",
	source: new ol.source.XYZ({
...
var obi1 = new ol.layer.Tile({
    ...
    zoom:16,
    icon:"<i class='fa fa-file-image-o' style='color:dimgrey;'></i>",
