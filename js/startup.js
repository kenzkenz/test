...
$(function(){
    ...
    if ($("body").width() > 400) {
        ...
        //msg += "！！現在も継続的に作成中です！！<br>";
        msg += "1 高知県古地図(大正14年)を追加しました。<br>";
        msg += "2 宮崎県古地図(大正14年)を追加しました。<br>";
        ...
        msg += "7 背景に九州１Kメッシュ人口を追加<br>";
        msg += "8 estatに10万人あたりの列を追加<br>";
        msg += "9 右クリックで人口機能完成 スマホは長押し<br>";
        ...
        msg += "宮崎県情報政策課<br>最終更新:2017/07/05</div>";
        $.notify({//options
            message: msg
        }, {//settings
            type: "danger",
