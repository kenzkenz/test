...
$(function(){
    ...
    if ($("body").width() > 400) {
        ...
        //msg += "！！現在も継続的に作成中です！！<br>";
        msg += "1 背景に東峰地区(7/30,31撮影)を追加しました。<br>";
        msg += "2 小地域人口等(MVT)から人口ピラミッドを作成します。<br>";
        msg += "3 背景に道路中心線・河川中心線を追加しました。<br>";
        msg += "4 背景に福井県の古地図を追加しました。<br>";
        msg += "5 背景にアジア航測株式会社撮影航空写真追加しました。<br>";
        msg += "6 背景に島根県の古地図を追加しました。<br>";
        msg += "7 背景に東峰地区の航空写真を追加しました。<br>";
       ...
       // msg += "11 GPX機能追加。<a href='dl.html' target='_blank'>サンプル</a><br>";
        ...
        msg += "宮崎県情報政策課<br>最終更新:2017/08/03</div>";
        $.notify({//options
            message: msg
        }, {//settings
            type: "danger",
