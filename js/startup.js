...
$(function(){
    ...
    if ($("body").width() > 400) {
        ...
        msg += "8 右クリックで人口機能完成 スマホは長押し<br>";
        msg += "9 CSV機能追加。<a href='dl.html' target='_blank'>サンプル</a><br>";
        msg += "10 GPX機能追加。<a href='dl.html' target='_blank'>サンプル</a><br>";
        ...
        msg += "宮崎県情報政策課<br>最終更新:2017/07/04</div>";
        $.notify({//options
            message: msg
        }, {//settings
            type: "danger",
