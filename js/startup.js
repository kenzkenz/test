...
$(function(){
    ...
    if ($("body").width() > 400) {
        ...
        msg += "1 背景に東峰地区の航空写真を追加しました。<br>";
        msg += "2 背景に小地域人口等を追加しました。<br>";
        msg += "3 背景に朝倉地区の航空写真を追加しました。<br>";
        msg += "4 背景に東京都、山口県の古地図を追加しました。<br>";
        msg += "5 背景に福岡県、大分県の大雨被害を追加しました。<br>";
        msg += "6 背景に宮城県・高知県の古地図を追加しました。<br>";
       ...
       // msg += "11 GPX機能追加。<a href='dl.html' target='_blank'>サンプル</a><br>";
        ...
        msg += "宮崎県情報政策課<br>最終更新:2017/07/18</div>";
        $.notify({//options
            message: msg
        }, {//settings
            type: "danger",
